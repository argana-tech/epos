...
return array(
	...
	'upload_file_path'  => array(
		'poster'  => dirname(__FILE__) . '/../uploads/poster/',
		'announce' => dirname(__FILE__) . '/../uploads/announce/',
	),

	'upload_temp_file_path'  => array(
		'poster'  => dirname(__FILE__) . '/../uploads/temp/poster/',
		'announce' => dirname(__FILE__) . '/../uploads/temp/announce/',
	),

	'watermark_file_path'  => dirname(__FILE__) . '/../files/watermark_epos.gif',
	'watermark_file_path2'  => dirname(__FILE__) . '/../files/watermark_epos.gif',
	'no_file_path'  => dirname(__FILE__) . '/../files/no.png',
	'lock_file_path'  => dirname(__FILE__) . '/../files/ppt.lock',
	'lock_file2_path'  => dirname(__FILE__) . '/../files/ppt2.lock',
	'update_error_log'  => dirname(__FILE__) . '/../logs/update_error.log',

	'allow_addr_show'  => array(
					'xxx.xxx.xxx.xxx',
					),
);
