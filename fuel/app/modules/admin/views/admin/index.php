<div class="col-sm-12">
	...
	<form class="form-inline well well-sm clearfix" account="<?php echo Uri::current(); ?>" method="get">
		...
		<div class="form-group">
			...
			<a href="<?php echo Uri::create('/admin/admin/new'); ?>" class="btn btn-sm btn-success">新規追加</a>
		</div>
	</form>
<?php if ($admins): ?>
	<div class="row">
	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td><a href="<?php echo Uri::create('/admin/admin/edit/' . $admin->id); ?>" class="btn btn-sm btn-success">編集</a></td>
			<td><a href="<?php echo Uri::create('/admin/admin/remove/' . $admin->id); ?>" onclick="return confirm('\'<?php echo e($admin->username); ?>\' を削除してもよろしいですか？')" class="btn btn-sm btn-danger"> 削除</td>
		</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
