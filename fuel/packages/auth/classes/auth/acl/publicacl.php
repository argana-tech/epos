...
class Auth_Acl_Publicacl extends \Auth_Acl_Driver
{
	...
	{
		static::$_valid_roles = array_keys(\Config::get('publicauth.roles'));
	}
	...
	public function has_access($condition, Array $entity)
	{
		...
		{
			$roles = \Config::get('publicauth.roles', array());
