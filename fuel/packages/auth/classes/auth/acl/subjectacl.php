...
class Auth_Acl_Subjectacl extends \Auth_Acl_Driver
{
	...
	{
		static::$_valid_roles = array_keys(\Config::get('subjectauth.roles'));
	}
	...
	public function has_access($condition, Array $entity)
	{
		...
		{
			$roles = \Config::get('subjectauth.roles', array());
