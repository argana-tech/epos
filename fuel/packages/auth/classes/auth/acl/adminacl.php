...
class Auth_Acl_Adminacl extends \Auth_Acl_Driver
{
	...
	{
		static::$_valid_roles = array_keys(\Config::get('adminauth.roles'));
	}
	...
	public function has_access($condition, Array $entity)
	{
		...
		{
			$roles = \Config::get('adminauth.roles', array());
