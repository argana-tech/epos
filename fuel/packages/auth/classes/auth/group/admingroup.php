...
class Auth_Group_Admingroup extends \Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('adminauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('Adminacl'))
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('adminauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('adminauth.groups');
