...
class Auth_Group_Publicgroup extends \Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('publicauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('Publicacl'))
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('publicauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('publicauth.groups');
		return $groups[(int) $group]['roles'];
	}
}

/* end of file publicgroup.php */
