...
class Auth_Group_Subjectgroup extends \Auth_Group_Driver
{
	...
	{
		static::$_valid_groups = array_keys(\Config::get('subjectauth.groups', array()));
	}

	protected $config = array(
		'drivers' => array('acl' => array('Subjectacl'))
	);
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('subjectauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('subjectauth.groups');
		return $groups[(int) $group]['roles'];
	}
}

/* end of file subjectgroup.php */
